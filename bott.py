...
cl = LINETCR.LINE() 
cl.login(token="Eq2Q3DlHmTwBH8ePVYc8.6S7B6iV24SxpyyIZPkjUga.bp+2tL0Wv/uO00Pu2bmSKZudtnVTZOvXJIFjccm/Qgo=")
print "cl login success"

ki = LINETCR.LINE() 
ki.login(token="Ep0Im22n6etgsmoNYeW9.Z2jqcI8fppmz+7xOGNlyEq.EQip/QZjGZqklE0I7Kps0r8q0hbwavO/kNgjf/yFbPA=")
print "ki login success"

kk = LINETCR.LINE() 
kk.login(token="EpRgAmBDNv2GmhWKzvja.Ql+Iq95c4olkmxSaoadLoG.CesNJzko5qHxyZ5apaizHgL1ZxbQTFdDEpuBYCpCKe0=")
print "ki2 login success"

kc = LINETCR.LINE() 
kc.login(token="EpPI22N90uDAu1OmMvL6.SGby4XQI1gAOTET1lBqQ9G.Z9Nk82VKZrpqnCz6DKZ0giucjQtPklTDRDxy2Psl/KY=")
print "ki3 login success"

ks = LINETCR.LINE() 
ks.login(token="Ep8cEFyZLRSuFjCH7Xla.Q6+YE7DHLRb+4/UXmbKggG.3ItR6kqsO0MninRGR0pXw0rQSOItPfUEm0MULNdvAlE=")
print "ki4 login success"

#kt = LINETCR.LINE() 
#kt.login(token="EpYvku0Q9fEFHWnY4Lp9.zun8h7rPPDCccXPYYHXDIq.CoCQr+/W6ssSuAvt4lx/XzkQahnkaL2o1sxt6He2eUc=")
...
╔═══════════════════
╠     ✍️MODIFIER✍️
╠❂͜͡➣ Bot1 rename:[ใส่ชื่อ] เปลี่ยนชื่อคิกเก้อ1
╠❂͜͡➣ Bot2 rename:[ใส่ชื่อ] เปลี่ยนชื่อคิกเก้อ2
╠❂͜͡➣ Bot3 rename:[ใส่ชื่อ] เปลี่ยนชื่อคิกเก้อ3
╠❂͜͡➣ Bot4 rename:[ใส่ชื่อ] เปลี่ยนชื่อคิกเก้อ4
╠❂͜͡➣ Bot5 rename:[ใส่ชื่อ] เปลี่ยนชื่อคิกเก้อ5
╠❂͜͡➣ Bot6 rename:[ใส่ชื่อ] เปลี่ยนชื่อคิกเก้อ6
╠❂͜͡➣ All rename:[ใส่ชื่อ] เปลี่ยนชื่อคิกเก้อทั้งหมด
╠❂͜͡➣ Allbio:[ใส่สะเตตัส] เปลี่ยนสเตตัส
╠❂͜͡➣ Bot1 clone @ - คิกเก้อ1ก๊อฟปี้@
╠❂͜͡➣ Bot2 clone @ - คิกเก้อ2ก๊อฟปี้@
╠❂͜͡➣ Bot3 clone @ - คิกเก้อ3ก๊อฟปี้@
╠❂͜͡➣ Bot4 clone @ - คิกเก้อ4ก๊อฟปี้@
╠❂͜͡➣ Bot5 clone @ - คิกเก้อ5ก็อฟปี้@
╠❂͜͡➣ Bot6 clone @ - คิกเก้อ6ก๊อปปี้@ 
╠❂͜͡➣ Comment: (ใส่คอมเม้น)
╠❂͜͡➣ Message:[ใส่ข้อความ]
╠❂͜͡➣ Bot1-6 backup run 1-6 กลับร่าง
╠❂͜͡➣ Bot1-6 backup 1-6 กลับร่างเดิม
╠❂͜͡➣ Group name:[text] เปลี่ยนชื่อห้อง
╚═══════════════════
╔═══════════════════
╠     ✍️PROMOTE/DEMOTE✍️
╠❂͜͡➣ Admin on @[name] ตั้งแอดมิน
╠❂͜͡➣ Expel on @[name] ปลดแอดมิน
╠❂͜͡➣ Expelall ปลดแอดมินทั้งหมด
╚═══════════════════
╔═══════════════════
╠     ✍️STEALING✍️
╠❂͜͡➣ Steal name    @[name] เอาชื่อ
╠❂͜͡➣ Steal Bio     @[name] 
╠❂͜͡➣ Steal status  @[name] เอาสะเตตัส
╠❂͜͡➣ Steal mid     @[name] เอาเอมไอดี
╠❂͜͡➣ Steal contact @[name] เอาคอนแท็ก
╠❂͜͡➣ Steal cover   @[name] เอารูปโปรไฟล์
╠❂͜͡➣ Steal pict    @[name] เอารูปปก
╠❂͜͡➣ Steal group pict เอารูปกลุ่ม
╠❂͜͡➣ Midpict:[mid] เอารูปเพื่อนผ่านเอมไอดี
╠❂͜͡➣ Copy @[name] เซลบอทก๊อฟปี้
╠❂͜͡➣ Kembali ke asli เซลกลับร่างเดิม
╚═══════════════════
╔═══════════════════
╠     ✍️GUARD MODE✍️
╠❂͜͡➣ Protect:low ป้องกันระดับต่ำ
╠❂͜͡➣ Protect:hight ป้องกันสูงสุด
╚═══════════════════
╔═══════════════════
╠     ✍️MARK TO LIST✍️
╠❂͜͡➣ Ban    @[name] สั่งดำ
╠❂͜͡➣ Unban  @[name] แก้ดำ
╠❂͜͡➣ Ban group: สั่งดำห้อง
╠❂͜͡➣ Del ban:
╠❂͜͡➣ List ban group รายชื่อห้องที่แบบใว้
╠❂͜͡➣ Banned[send contact] ส่งดำส่ง คท.
╠❂͜͡➣ Unbanned[send contact] แก้ดำส่ง คท.
╠❂͜͡➣ Ban repeat @[name]
╠❂͜͡➣ Blacklist all สั่งดำทั้งหมด
╠❂͜͡➣ Ban cek      เตะดำทั้งหมด
╠❂͜͡➣ Clear banlist เตะดำ
...
╔═══════════════════
╠     ✍️INVITATION✍️
╠❂͜͡➣ Invite:[mid] เชิญด้วย mid
╠❂͜͡➣ Invite user[contact] เชิญเพื่อน ส่ง คท.
╠❂͜͡➣ Invite me 
╠❂͜͡➣ Join all บอทเข้า
╠❂͜͡➣ Join group สั่งบอทเข้าห้อง ใส่ชื่อห้อง
╚═══════════════════
╔═══════════════════
╠     ✍️LEAVE GROUP✍️
╠❂͜͡➣ Bot2   @bye คิก1 ออก
╠❂͜͡➣ Bot3   @bye คิก2 ออก
╠❂͜͡➣ Bot4   @bye คิก3 ออก
╠❂͜͡➣ Bot5   @bye คิก4 ออก
╠❂͜͡➣ Bot6   @bye คิก5 ออก
╠❂͜͡➣ Bye all   คิกออกทั้งหมด
╠❂͜͡➣ Center @bye สั่งออกทั้งเซลและคิกเก้อ
╠❂͜͡➣ Bye allgroups[own] สั่งออกทุกห้อง ใส่ชื่อแอด
╠❂͜͡➣ Leave group: 
╚═══════════════════
╔═══════════════════
...
#==================================================================
            ...
            elif "Admove on @" in msg.text:
                if msg.from_ in owner:
                    print "[Command]Staff remove executing"
                    _name = msg.text.replace("Admove on @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
